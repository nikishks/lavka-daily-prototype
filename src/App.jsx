...
// Logo Component (Органическая форма - сердце с выемкой сверху)
const Logo = ({ size = 32 }) => (
  <svg 
    width={size} 
    height={size} 
  ...
  >
    {/* Яркий синий фон */}
    <rect width="100" height="100" rx="20" fill="#02ADFF"/>
    {/* Белая органическая форма с выемкой сверху (мягкое сердце) */}
    <path 
      d="M50 18
         C40 18, 28 22, 22 30
         C16 38, 16 48, 22 54
